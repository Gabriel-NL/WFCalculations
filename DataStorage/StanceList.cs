namespace WFCalculations
{
    ...
    public struct Stance { public Dictionary<string, Combo> ComboDictionary; }
    public struct Combo { public StanceHit[] AllHits; public float ComboDuration; }
    ...
    public static class StanceList
    {
        ...
        public static Dictionary<string, Stance> DAGGER_STANCE_DICTIONARY = new Dictionary<string, Stance>()
        {
            {"Stanceless", new Stance()
                {
                    ComboDictionary = new Dictionary<string, Combo>()
                    {
                        {NeutralCombo,new Combo()
                            {
                                AllHits =
                                [
                                    new StanceHit(),
                        ...
                        {ForwardAndBlockCombo,new Combo()
                            {
                                AllHits =
                                [
                                    new StanceHit(),
        ...
        public static Dictionary<string, Stance> STAFF_STANCE_DICTIONARY = new Dictionary<string, Stance>()
        {
            { "Stanceless", new Stance()
            {
                ComboDictionary = new Dictionary<string, Combo>(){
